...
public class HelloController implements Initializable {
    private ArrayList<Music>  musicList = new ArrayList<>();//存放音樂
    private int curr = 0;//目前音樂
    private MediaPlayer PrimaryMediaPlayer;//主播放
    private String PlayStatus = "default";//播放狀態 預設(順播),隨機,循環

    private Image ImagePause = new Image(Objects.requireNonNull(getClass().getResourceAsStream("pause.png")));
    private Image ImageStart = new Image(Objects.requireNonNull(getClass().getResourceAsStream("PlayButton.png")));
